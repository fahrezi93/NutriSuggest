...
const NutritionAnalysis: React.FC<NutritionAnalysisProps> = ({ analysis, healthAdvice }) => {
  const macroData = [
    { name: 'Protein', value: analysis.protein_percentage, color: '#0ea5e9' },
    { name: 'Karbohidrat', value: analysis.carb_percentage, color: '#22c55e' },
    { name: 'Lemak', value: analysis.fat_percentage, color: '#f59e0b' }
  ];

  const nutritionData = [
    { name: 'Serat', value: analysis.fiber_content, color: '#8b5cf6' },
    { name: 'Gula', value: analysis.sugar_content, color: '#ef4444' }
  ];
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-success-50 rounded-lg">
                <div className="text-xl font-bold text-success-700">{analysis.fiber_content}g</div>
                <div className="text-sm text-success-600">Serat</div>
              </div>
              <div className="text-center p-3 bg-warning-50 rounded-lg">
                <div className="text-xl font-bold text-warning-700">{analysis.sugar_content}g</div>
