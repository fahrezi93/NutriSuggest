    ...
    <section className="py-20 bg-white">
      <div className="container-max">
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-primary-200 via-secondary-200 to-success-200 transform -translate-y-1/2 z-0"></div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Card */}
                <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-white/20">
                  {/* Step Number */}
