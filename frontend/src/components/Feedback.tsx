...
import { X, MessageSquare, Star, Send, AlertCircle, CheckCircle } from 'lucide-react';
...
const Feedback: React.FC<FeedbackProps> = ({ onClose }) => {
  ...
  const sendToSpreadsheet = async (feedbackData: any) => {
    ...
    formData.append('feedbackType', feedbackData.type);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send to spreadsheet
      await sendToSpreadsheet(feedbackData);
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600">Feedback Anda telah berhasil dikirim ke spreadsheet kami. Tim kami akan meninjaunya segera.</p>
        </motion.div>
      </motion.div>
    );
  }
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              <span>{isSubmitting ? 'Mengirim ke Spreadsheet...' : 'Kirim Feedback'}</span>
            </button>
          </form>
